...
const FALLBACK_IMAGE = "/fallback.jpg"; // Must exist in public/
...
const RecipeListPage = ({ category }) => {
  ...
  useEffect(() => {
    ...
    // Debounce search to avoid multiple re-renders
    timeout = setTimeout(fetchImageIfNoMatch, 500);
  ...
  return (
    <>
      ...
      {/* Footer always outside recipe content to avoid flicker */}
      <Footer />
    </>
  );
};
